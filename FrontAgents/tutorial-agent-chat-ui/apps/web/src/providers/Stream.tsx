        ...
        <div className="animate-in fade-in-0 zoom-in-95 flex flex-col border bg-background shadow-lg rounded-lg max-w-3xl">
          <div className="flex flex-col gap-2 mt-14 p-6 border-b">
            ...
            <p className="text-muted-foreground">
              Bem vindo ao buscar melhor valor! Antes de iniciar você deverá
              entrar com a URL de deployment do seu assistente / ou
              identificação.
            </p>
          </div>
          <form
          ...
          >
            <div className="flex flex-col gap-2">
              <Label htmlFor="apiUrl">
                URL do deploy<span className="text-rose-500">*</span>
              </Label>
              <p className="text-muted-foreground text-sm">
                A URL do seu LangGraph onde existe seu agente. Você pode subir
