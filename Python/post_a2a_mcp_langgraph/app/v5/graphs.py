...
from agents import aritmetica_node

workflow = StateGraph(CalcState)

workflow.add_node("aritmetica", aritmetica_node)
...
workflow.add_edge(START, "aritmetica")
workflow.add_edge("aritmetica", "decisor")
...
graph = workflow.compile(name="Agente simples de aritmética")
